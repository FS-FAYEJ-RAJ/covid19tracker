/// updated : 1648654196669
/// cases : 486098236
/// todayCases : 1059862
/// deaths : 6158827
/// todayDeaths : 2299
/// recovered : 421343672
/// todayRecovered : 674276
/// active : 58595737
/// critical : 58518
/// casesPerOneMillion : 62362
/// deathsPerOneMillion : 790.1
/// tests : 6065918741
/// testsPerOneMillion : 768767.36
/// population : 7890447810
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 7426.16
/// recoveredPerOneMillion : 53399.21
/// criticalPerOneMillion : 7.42
/// affectedCountries : 227

class WorldStatasModels {
  WorldStatasModels({
      int? updated, 
      int? cases, 
      int? todayCases, 
  ...
  WorldStatasModels.fromJson(dynamic json) {
